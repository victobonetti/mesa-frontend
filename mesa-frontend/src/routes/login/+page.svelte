...
const loginTrigger = async () =>{
	...
	let result = await LoginService.doLogin(email, pass)
...
<div
	class=" h-96 w-96 border rounded shadow-lg bg-neutral-100 p-8 flex flex-col items-center justify-center"
>
	<h1 class="text-4xl select-none mb-2 font-semibold">MesaErp</h1>
	<h4 class="select-none mb-6">Operação simplificada</h4>
	<div class="w-72 mb-2">
